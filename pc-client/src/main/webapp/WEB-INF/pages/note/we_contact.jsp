...
<style type="text/css">
	#note_right { float: left; margin-left: 10px; width: 980px; height: 480px; overflow: hidden; background: #fff;}
		#nr_tit { font-size: 20px; color: #666; padding: 22px 0px 0px 22px;}
		#nr_img { wdith: 600px; height: 375px; background: #fff url(${staUrl }/images/note/_lxwm.png) no-repeat; margin-left: 180px;}
</style>
