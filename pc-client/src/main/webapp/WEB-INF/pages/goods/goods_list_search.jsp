	...
	<div id="goods_list_con" class="clear">
		...
		<div id="glc_rt">
			...
			<div id="glc_rt_pcon">
				...
				<c:if test="${fn:length(goodslistsearch) > 0}">
					<c:forEach items="${goodslistsearch}" var="goods">
								...
								<ul class="grgp_ul clear">
									<c:if test="${goods.isSale == 1 }">
										<li class="grgp_ul_num_li">
											...
											<input class="grgp_ul_num grgp_ul_inp" type="text" value="1" tmp="1" />
									...
									<c:if test="${goods.isSale == 2 }">
										<li class="grgp_ul_num_li">
											...
											<input class="grgp_ul_num grgp_ul_inp" type="text" value="1" readonly="readonly" style="color: #aeaeae;" />
											<a class="grgp_ul_num grgp_ul_a" href="javascript:;" style="color: #aeaeae;"></a>
										</li>
										<li class="grgp_ul_car_li">
				...
				<c:if test="${fn:length(goodslistsearch) == 0}">
					<div id="glc_rt_nogoods">
						<div id="glc_rt_ng_cn" class="clear">
							<span id="grnc_img"></span>
							<p>
								<span>抱歉，没有找到与“</span>
								<span id="grnc_txt">${contentEscape }</span>
								<span>”相关的商品</span>
							</p>
						</div>
					</div>
			...
			<!-- 自定义分页组件 -->
			<form id="fm_goodsList" action="${rootUrl }/goods/getGoodsListBySearch.htm" method="get">
