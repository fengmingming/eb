...
<title>手拉手后台管理系统</title>
<style type="text/css">
	* { margin: 0px; padding: 0px;}
	html, body { height: 100%; font-family: Microsoft Yahei;}
	#con { position: relative; width: 100%; height: 100%; background:url('/sls-cms/image/login.jpg') no-repeat center center;}
...
<body>
	<div id="con">
		...
		<form id="log_fm" action="/sls-cms/user/login.htm" method="post">
