package net.sls.controller.commons;
...
public class AuthHandler implements HandlerInterceptor{
	...
	private final String script = "<script type=\"text/javascript\"> window.location.href = \"/sls-cms\" </script>";
	
	private final String script2 = "<script type=\"text/javascript\"> window.parent.location.href = \"/sls-cms\" </script>";
