package net.sls.mobile.client.util;
...
public class Constants {
	 ...
	 * 服务器路径
	 */
	public static final String HOST = "http://test.365020.com/mobile";
	//public static final String HOST = "http://www.365020.com/mobile";
	public static final String PATH = "/";
	public static final String SERVER_URL = HOST;
	public static final String SERVICE_URL = "http://localhost:8080/m-servlet";
	//public static final String SERVICE_URL = "http://localhost:8080/pc-servlet";
	//public static final String SERVICE_URL = "http://localhost:9999/pc-servlet-mobile";
...
//	public static final String ALIAPY_PARAM_NOTIFYURL_VALUE = Constants.SERVER_URL + "/alipay/notify_url.htm";
	 ...
	 * 商品列表每页显示的商品数
	 */
	public static final int GOODS_ACTIVITY_NUM_PAGE = 12;
